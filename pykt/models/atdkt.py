...
class ATDKT(Module):
    def __init__(self, num_q, num_c, seq_len, emb_size, dropout=0.1, emb_type='qid', 
        ...
        if self.emb_type.endswith("predcurc"): 
            self.l1 = l1
            self.l2 = l2
            self.l3 = l3
            if self.num_q > 0:
    ...
    def predcurc(self, dcur, device, q, c, r, xemb, train):
    ...
    def forward(self, dcur, device, train=False): 
        ...
        if emb_type == "qid":
            ...
            y, y2, y3 = self.predcurc(dcur, device, q, c, r, xemb, train)
