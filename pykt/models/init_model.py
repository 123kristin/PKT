...
def init_model(model_name, model_config, data_config, emb_type):
    if model_name == "dkt":
        ...
        # model = rnnCapsule(data_config["num_c"], **model_config, emb_type=emb_type, emb_path=data_config["emb_path"]).to(device)
      
        model = rnnCapsule(data_config["num_c"], data_config["num_q"], **model_config, emb_type=emb_type, emb_path=data_config["emb_path"]).to(device)
    elif model_name == "dkt+":
