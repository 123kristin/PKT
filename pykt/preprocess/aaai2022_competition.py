...
# dname = "../../pykt-toolkit-main/data/peiyou.ori/"
# q2cfile = "../../pykt-toolkit-main/data/peiyou.ori/map_questions.json"
# dq2c = load_q2c(q2cfile)

# train_valid_fname = "../../pykt-toolkit-main/data/peiyou.ori/map_train_valid.csv"
# merged_train_valid = merge_cs(train_valid_fname, dq2c)
# merged_train_valid.to_csv("../../pykt-toolkit-main/data/peiyou.ori/merged_map_train_valid.csv")

# earlyf = "../../pykt-toolkit-main/data/peiyou.ori/map_test_early_with_label.csv"
# latef = "../../pykt-toolkit-main/data/peiyou.ori/map_test_late.csv"
